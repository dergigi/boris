...
import { includeReplaceableIdentifier, modifyTags, sign, stamp, stripSignature, stripStamp, stripSymbols, updateCreatedAt, Client, } from "./operations/index.js";
...
export async function create(context, blueprintConstructor, ...args) {
...
export class EventFactory {
    ...
    async create(blueprintConstructor, ...args) {
